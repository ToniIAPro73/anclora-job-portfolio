...
APPLICATION_NAME=Anclora Job Portfolio
REPOSITORY=anclora-job-portfolio
...
PRODUCTION_DOMAIN=anclora-job-portfolio.anclora.com
PRODUCTION_DEPLOYMENT_PROVIDER=Node.js / Self-Hosted

```text
Browser / Client
   ↓
Node.js / Self-Hosted Frontend (Node.js)
   ↓
Backend Services
   ├── Database: None
